...
function defaultSpawnCommandBuilder(
  ...
  const teammateContext = [
    ...
    '',
    'CRITICAL REQUIREMENT — YOU MUST DO THIS BEFORE FINISHING:',
    `1. For each task you complete, call update_task to mark it completed`,
    `2. After ALL your work is done, call send_message with to="lead" and a detailed summary of:`,
    '   - What you found or accomplished',
    '   - Any issues, risks, or recommendations',
    '   - Files changed (if any)',
    'Do NOT exit without sending the summary message to the lead.',
    '',
    'YOUR TASK:',
  ].join('\n');
